...
import pandas as pd
# --------------------------------------------------
# Add VITARON-THE-VALIANT root to Python path
# --------------------------------------------------

current_dir = os.path.dirname(os.path.abspath(__file__))     # Fusion_product/
project_root = os.path.dirname(current_dir)                  # VITARON-THE-VALIANT/
sys.path.append(project_root)
sys.path.insert(0, project_root)  

# --------------------------------------------------
# Import pipelines from code/
# --------------------------------------------------

from code.time_gated_raman import raman_pipeline_from_csv, RamanFeatures
from code.nir_pipeline import nir_pipeline_from_csv, NIRFeatures
from code.pas_pipeline import pas_pipeline_from_csv, PASFeatures
from code.rf_pipeline import rf_pipeline_from_csv, RFFeatures
